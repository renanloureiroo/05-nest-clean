...
describe('On Answer Created', () => {
  beforeEach(() => {
    ...
    new OnQuestionBestAnswerChosen(answersRepository, sendNotificationUseCase) // eslint-disable-line
  })
  it('should send a notification when has new question best answer chosen', async () => {
